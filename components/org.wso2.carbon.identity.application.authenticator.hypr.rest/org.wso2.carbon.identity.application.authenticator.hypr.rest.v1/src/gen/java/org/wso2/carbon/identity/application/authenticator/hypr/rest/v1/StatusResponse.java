...
public class StatusResponse {
    ...
    public enum StatusEnum {
        ...
        @XmlEnumValue("REQUEST_SENT") REQUEST_SENT(String.valueOf("REQUEST_SENT")),
        @XmlEnumValue("INITIATED") INITIATED(String.valueOf("INITIATED")),
        @XmlEnumValue("INITIATED_RESPONSE") INITIATED_RESPONSE(String.valueOf("INITIATED_RESPONSE")),
        @XmlEnumValue("COMPLETED") COMPLETED(String.valueOf("COMPLETED")),
        @XmlEnumValue("CANCELED") CANCELED(String.valueOf("CANCELED")),
        @XmlEnumValue("FAILED") FAILED(String.valueOf("FAILED"));
